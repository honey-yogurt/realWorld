...
type RealWorldClient interface {
	...
	DeleteComments(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*MultipleCommentsReply, error)
...
func (c *realWorldClient) DeleteComments(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*MultipleCommentsReply, error) {
	out := new(MultipleCommentsReply)
...
func (UnimplementedRealWorldServer) DeleteComments(context.Context, *DeleteCommentRequest) (*MultipleCommentsReply, error) {
...
func _RealWorld_DeleteComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).DeleteComments(ctx, req.(*DeleteCommentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
